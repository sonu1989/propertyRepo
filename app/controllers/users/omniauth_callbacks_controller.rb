class Users::OmniauthCallbacksController < Devise::OmniauthCallbacksController
  ...
  def github
      # You need to implement the method below in your model (e.g. app/models/user.rb)
      @user = User.find_for_github_auth(request.env["omniauth.auth"], current_user)
  ...
  def twitter
      # You need to implement the method below in your model (e.g. app/models/user.rb)
      @user = User.find_for_twitter_auth(request.env["omniauth.auth"].except("extra"), current_user)
      if @user.persisted?
